...
def scaleWheel():
    ...
    rospy.Subscriber("lwheel", Int32, lwheelCallback)
    rospy.Subscriber("rwheel", Int32, rwheelCallback)
    
    lscaled_pub = rospy.Publisher("lwheel_scaled", Int32, queue_size=10)
    rscaled_pub = rospy.Publisher("rwheel_scaled", Int32, queue_size=10) 
